...
$_['text_success']          = 'Успех: Вы изменили отчет о бонусных баллах покупателя!';
...
// Error
$_['error_permission']      = 'Внимание: У вас нет прав на изменение отчета о бонусных баллах покупателя!';