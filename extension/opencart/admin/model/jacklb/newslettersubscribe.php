...
class Modeljacklbnewslettersubscribe extends \Opencart\System\Engine\Model {
	...
	public function UpdateRegisterUsers($data,$status): array {
	...
	public function delete($data): array {
   	...
   	public function check_db(): array{
