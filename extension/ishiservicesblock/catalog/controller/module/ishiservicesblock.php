<?php
namespace Opencart\Catalog\Controller\Extension\ishiservicesblock\Module;
class IshiServicesBlock extends \Opencart\System\Engine\Controller {
	public function index(array $setting): string {
		...
		if($column == 1){
			...
			$data['class'] = 'col-lg-3 col-md-6 col-sm-6 col-xs-6 col-12';
		}
		...
		return $this->load->view('extension/ishiservicesblock/module/ishiservicesblock', $data);
	}
}