<?php
namespace Opencart\Catalog\Controller\Extension\ishistoreinfoblock\Module;
class IshiStoreInfoBlock extends \Opencart\System\Engine\Controller {
	...
	public function index(array $setting): string {
		...
		$data['ishi_randomnumer'] = "ishistoreinfoblock" . rand();
		...
		if(isset($setting['alignment'])) {
			$data['alignment'] = $setting['alignment'];
		}
		...
		return $this->load->view('extension/ishistoreinfoblock/module/ishistoreinfoblock', $data);
	}
