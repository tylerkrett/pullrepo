<?php
namespace Opencart\Admin\Controller\Extension\ishiproductsblock\Module;
...
class IshiProductsBlock extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/ishiproductsblock/module/ishiproductsblock', 'user_token=' . $this->session->data['user_token'], true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title1'),
				'href' => $this->url->link('extension/ishiproductsblock/module/ishiproductsblock', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true)
			);
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/ishiproductsblock/module/ishiproductsblock', 'user_token=' . $this->session->data['user_token'], true);
		} else {
			$data['action'] = $this->url->link('extension/ishiproductsblock/module/ishiproductsblock', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
		}
		...
		if (isset($this->request->post['product_category'])) {
			...
			$data['category'] = $module_info['product_category'];
		} else {
			$data['category'] = '';
		}
		...
		$this->response->setOutput($this->load->view('extension/ishiproductsblock/module/ishiproductsblock', $data));
	}
	...
	protected function validate() {
		...
		if (!$this->user->hasPermission('modify', 'extension/ishiproductsblock/module/ishiproductsblock')) {
		...
		if (!$json) {
			...
			if (!isset($this->request->get['module_id'])) {
				$this->model_setting_module->addModule('ishiproductsblock.ishiproductsblock', $this->request->post);
			} else {
				$this->model_setting_module->editModule($this->request->get['module_id'], $this->request->post);
			}
