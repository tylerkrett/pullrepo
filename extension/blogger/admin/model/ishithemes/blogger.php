<?php
namespace Opencart\Admin\Model\Extension\blogger\ishithemes;
	...
	public function getBlogsByModule($data) {
		$module_id = $data['module_id'];
		$sql = "SELECT * FROM " . DB_PREFIX . "blogger b LEFT JOIN " . DB_PREFIX . "blogger_description bd ON (b.blogger_id = bd.blogger_id) WHERE bd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND b.module_id = '" . (int)$module_id . "' ORDER BY b.date_added";
