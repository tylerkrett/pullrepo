...
class Blogger extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		$this->load->model('extension/blogger/ishithemes/blogger');
		...
		if (!isset($this->request->get['module_id'])) {
			$data['text_view_list'] = sprintf($this->language->get('text_view_list'), $this->url->link('extension/blogger/module/blogger|view_list', 'user_token=' . $this->session->data['user_token'], true));
		} else {
			$data['text_view_list'] = sprintf($this->language->get('text_view_list'), $this->url->link('extension/blogger/module/blogger|view_list', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true));
		}
		...
		} elseif (!empty($module_info) && isset($module_info['comments'])) {
		...
		} elseif (!empty($module_info) && isset($module_info['login'])) {
		...
		} elseif (!empty($module_info) && isset($module_info['auto_approve'])) {
		...
		$blogger_total = $this->model_extension_blogger_ishithemes_blogger->getTotalBlogs();
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$results = $this->model_extension_blogger_ishithemes_blogger->getBlogsByModule($filter);
		}
		if ($results) {
			foreach ($results as $result) {
				$total_comments = $this->model_extension_blogger_ishithemes_blogger->getTotalBlogComments($result['blogger_id']);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'url'   => $this->url->link('extension/blogger/module/blogger', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'] . '&page={page}')
		]);
	...
	public function install() {
		...
		$this->model_extension_blogger_ishithemes_blogger->createBlogs();
	}

	public function uninstall() {
		$this->load->model('extension/blogger/ishithemes/blogger');

		$this->model_extension_blogger_ishithemes_blogger->dropBlogs();
	}
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_blogger_ishithemes_blogger->addBlog($this->request->post, $this->request->post['module_id']);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_blogger_ishithemes_blogger->editBlog($this->request->get['blogger_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blogger_id) {
				$this->model_setting_ishithemes_blogger->deleteBlog($blogger_id);
			}
			...
			$this->model_extension_blogger_ishithemes_blogger->deleteBlog($this->request->get['blogger_id']);
	...
	protected function getForm() {
		...
		if (isset($this->request->get['blogger_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$blogger_info = $this->model_extension_blogger_ishithemes_blogger->getBlog($this->request->get['blogger_id']);
		}
		...
		if (isset($this->request->post['blogger_description'])) {
			...
			$data['blogger_description'] = $this->model_extension_blogger_ishithemes_blogger->getBlogDescriptions($this->request->get['blogger_id']);
		} else {
		...
		foreach ($modules as $module) {
			if (!isset($data['blogger_modules'][$module['code']])) {
				$data['blogger_modules'][$module['code']]['name'] = $this->language->get('heading_title1');
			}
	...
	protected function getList() {
		...
		$results = $this->model_extension_blogger_ishithemes_blogger->getBlogs($filter_data);
		...
		foreach ($results as $result) {
			$module_info = $this->model_extension_blogger_ishithemes_blogger->getModule($result['module_id']);
			...
			$blogger_total = $this->model_extension_blogger_ishithemes_blogger->getTotalBlogs($result['blogger_id']);
	...
	protected function getComments() {
		...
		$blog_info = $this->model_extension_blogger_ishithemes_blogger->getBlog($this->request->get['blogger_id']);

		$blog_title = $this->model_extension_blogger_ishithemes_blogger->getBlogTitle($this->request->get['blogger_id']);
		...
		$blog_comment_total = $this->model_extension_blogger_ishithemes_blogger->getTotalBlogComments($this->request->get['blogger_id']);

		$results = $this->model_extension_blogger_ishithemes_blogger->getBlogComments($this->request->get['blogger_id'], $filter_data);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/blogger/module/blogger|comments', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'] . $url . '&blogger_id=' . $this->request->get['blogger_id'] . '&page={page}')
	...
	public function approve_comment() {
		...
		$this->model_extension_blogger_ishithemes_blogger->approveComment($this->request->get['blogger_comment_id']);
	...
	public function disapprove_comment() {
		...
		$this->model_extension_blogger_ishithemes_blogger->disapproveComment($this->request->get['blogger_comment_id']);
	...
	public function delete_comment() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blogger_comment_id) {
				$this->model_setting_ishithemes_blogger->deleteBlogComment($blogger_comment_id);
			}
	...
	protected function viewComment() {
		...
		$comment_info = $this->model_extension_blogger_ishithemes_blogger->getBlogComment($this->request->get['blogger_comment_id']);

		$comment_descriptions = $this->model_extension_blogger_ishithemes_blogger->getBlogCommentDescriptions($this->request->get['blogger_comment_id']);
