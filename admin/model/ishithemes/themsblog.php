<?php
namespace Opencart\Admin\Model\Extension\Opencart\Ishithemes;
class Themsblog extends \Opencart\System\Engine\Model {
	...
	public function addBlog($data) {
		...
		foreach ($data['themsblog'] as $language_id => $value) {
	...
	public function getBlogsByModule($module_id) {
		...
		// $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "blogger_description");
		// print_r ($query); exit;	
		return $query->rows;
	}
