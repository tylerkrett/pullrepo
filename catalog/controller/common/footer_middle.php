...
class FooterMiddle extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'footer_middle');
		...
		return $this->load->view('common/footer_middle', $data);
	}
}
