...
class ContentCenter extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'content_center');
		...
		return $this->load->view('common/content_center', $data);
	}
}
