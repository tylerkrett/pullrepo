...
class FooterBefore extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'footer_before');
		...
		return $this->load->view('common/footer_before', $data);
	}
}
