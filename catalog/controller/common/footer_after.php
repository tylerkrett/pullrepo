...
class FooterAfter extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'footer_after');
		...
		return $this->load->view('common/footer_after', $data);
	}
}
