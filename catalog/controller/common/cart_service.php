...
class CartService extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'cart_service');
		...
		return $this->load->view('common/cart_service', $data);
	}
}
