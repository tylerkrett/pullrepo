...
class HeaderAfter extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'header_after');
		...
		return $this->load->view('common/header_after', $data);
	}
}
