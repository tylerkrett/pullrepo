...
class HeaderBefore extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'header_before');
		...
		return $this->load->view('common/header_before', $data);
	}
}
