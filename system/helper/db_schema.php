...
function oc_db_schema() {
	...
	$tables[] = [
		'name' => 'blogger_comment_description',
		'field' => [
			[
				'name' => 'blogger_comment_id',
				'type' => 'int(11)',
	...
	$tables[] = [
		...
		'field' => [
			...
			[
				'name' => 'tophome_bgcolor',
				'type' => 'varchar(20)',
				'not_null' => false
			],
			[
				'name' => 'headernav_bgcolor',
				'type' => 'varchar(20)',
				'not_null' => false
			],
			[
				'name' => 'headernav_textcolor',
				'type' => 'varchar(20)',
				'not_null' => false
			],
			[
			...
			[
				'name' => 'footer_text_hovercolor',
				'type' => 'varchar(20)',
				'not_null' => false
			],
			[
				'name' => 'footerafter_bgcolor',
				'type' => 'varchar(500)',
				'not_null' => false
			],
			[
				'name' => 'footerafter_textcolor',
				'type' => 'varchar(20)',
				'not_null' => false
			],
			[
