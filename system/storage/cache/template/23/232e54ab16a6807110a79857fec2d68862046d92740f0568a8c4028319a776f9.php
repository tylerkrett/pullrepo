...
class __TwigTemplate_1176dfa7253a47e144ac85e5691317323baff3ba77297c0af3db4d00f26bc780 extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["customer_approvals"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["customer_approval"]) {
              ...
              <td class=\"text-start\">";
                ...
                echo "</td>
              <td class=\"text-end\" style=\"min-width: 103px;\"><button type=\"button\" value=\"";
                // line 25
  ...
  <div class=\"row\">
    ...
    {
        return new Source("", "admin/view/template/customer/customer_approval_list.twig", "C:\\xampp\\htdocs\\OPC125L01_new\\admin\\view\\template\\customer\\customer_approval_list.twig");
    }
}
