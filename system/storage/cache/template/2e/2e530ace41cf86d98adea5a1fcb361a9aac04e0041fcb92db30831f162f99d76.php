...
class __TwigTemplate_5665c4408e2de4f80033a3fb8c925d35817e202e5d8459b907f3c137a504642b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<td class=\"text-end\">";
                // line 18
                echo twig_get_attribute($this->env, $this->source, $context["category"], "sort_order", [], "any", false, false, false, 18);
                echo "</td>
\t\t\t\t\t\t\t<td class=\"text-end\"><a href=\"";
                // line 19
                echo twig_get_attribute($this->env, $this->source, $context["category"], "edit", [], "any", false, false, false, 19);
...
";
    ...
    {
        return new Source("", "admin/view/template/catalog/category_list.twig", "C:\\xampp\\htdocs\\OPC145\\admin\\view\\template\\catalog\\category_list.twig");
    }
}
