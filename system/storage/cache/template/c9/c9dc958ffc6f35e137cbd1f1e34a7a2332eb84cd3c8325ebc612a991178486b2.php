...
class __TwigTemplate_b815f986951d86f6c75a46db842291555123ecce57920a7316cfd2555273e916 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<form id=\"form-customer-group\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"";
        echo ($context["action"] ?? null);
        echo "\" data-oc-target=\"#customer-group\">
...
\t\t\t\t\t\t\t<td class=\"text-end\">";
                // line 18
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "sort_order", [], "any", false, false, false, 18);
                echo "</td>
\t\t\t\t\t\t\t<td class=\"text-end\"><a href=\"";
                // line 19
                echo twig_get_attribute($this->env, $this->source, $context["customer_group"], "edit", [], "any", false, false, false, 19);
...
\t</div>
    ...
    {
        return new Source("", "admin/view/template/customer/customer_group_list.twig", "C:\\xampp\\htdocs\\OPC125L01_new\\admin\\view\\template\\customer\\customer_group_list.twig");
    }
}
